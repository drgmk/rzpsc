...
\begin{figure*}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=\textwidth]{yearly-2004.eps}
...
\begin{figure*}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=\textwidth]{yearly-zoom.eps}
...
\begin{figure*}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{RZ-Psc.eps}
...
\begin{figure*}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=\textwidth]{wise-var.eps}
...
\begin{figure}
\begin{center}
\hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{auto.eps}
...
% \begin{figure*}
  % \begin{center}
  %   \hspace{-0.cm} \includegraphics[width=\textwidth]{lc_dips_dts.ps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{hist_single.ps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{gradients.eps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{sma.eps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{rcl-a.eps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{spcomp.eps}
...
\begin{figure}
  \begin{center}
    \hspace{-0.5cm} \includegraphics[width=0.7\textwidth]{cartoon-crop.ps}
...
\bibitem{1984A&AS...55..109F}
{Finkenzeller} U, {Mundt} R.
\newblock {The Herbig Ae/Be stars associated with nebulosity}.
...
\bibitem{2007prpl.conf..539M}
{Millan-Gabet} R, {Malbet} F, {Akeson} R, {Leinert} C, {Monnier} J, {Waters} R.
\newblock {The Circumstellar Environments of Young Stars at AU Scales}.
...
\bibitem{2013ApJ...776...77K}
{K{\'o}sp{\'a}l} {\'A}, {Mo{\'o}r} A, {Juh{\'a}sz} A, {{\'A}brah{\'a}m} P,
  {Apai} D, {Csengeri} T, et~al.
\newblock {ALMA Observations of the Molecular Gas in the Debris Disk of the 30
  Myr Old Star HD 21997}.
...
\newblock {Rapid disappearance of a warm, dusty circumstellar disk}.
...
\bibitem{1991A&AS...89..319B}
{Bibo} EA, {The} PS.
\newblock {The type of variability of Herbig Ae/Be stars}.
...
\bibitem{2005ApJ...630L.185C}
{Calvet} N, {D'Alessio} P, {Watson} DM, {Franco-Hern{\'a}ndez} R, {Furlan} E,
  {Green} J, et~al.
\newblock {Disks in Transition in the Taurus Population: Spitzer IRS Spectra of
  GM Aurigae and DM Tauri}.
...
\bibitem{2006ApJS..166..351C}
{Chen} CH, {Sargent} BA, {Bohac} C, {Kim} KH, {Leibensperger} E, {Jura} M,
  et~al.
\newblock {Spitzer IRS Spectroscopy of IRAS-discovered Debris Disks}.
\newblock \apjs. 2006 Sep;166:351--377.
\newblock Available from:
  \url{http://adsabs.harvard.edu/abs/2006ApJS..166..351C}.

\bibitem{2014MNRAS.443.1587R}
{Rodgers-Lee} D, {Scholz} A, {Natta} A, {Ray} T.
\newblock {The Herschel view of circumstellar discs: a multiwavelength study of
  Chamaeleon-I}.
...
\bibitem{2015ApJ...805...77M}
{Meng} HYA, {Su} KYL, {Rieke} GH, {Rujopakarn} W, {Myers} G, {Cook} M, et~al.
\newblock {Planetary Collisions Outside the Solar System: Time Domain
  Characterization of Extreme Debris Disks}.
...
\bibitem{2016MNRAS.462L.101A}
{Ansdell} M, {Gaidos} E, {Williams} JP, {Kennedy} G, {Wyatt} MC, {LaCourse} DM,
  et~al.
\newblock {Dipper discs not inclined towards edge-on orbits}.
\newblock \mnras. 2016 Oct;462:L101--L105.
\newblock Available from:
  \url{http://adsabs.harvard.edu/abs/2016MNRAS.462L.101A}.

\bibitem{1987ApJ...323..714K}
{Kenyon} SJ, {Hartmann} L.
\newblock {Spectral energy distributions of T Tauri stars - Disk flaring and
  limits on accretion}.
